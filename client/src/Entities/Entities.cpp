...
client::Entities::Entities(int id, size_t type, string name) {
    ...
    switch(type) {
        case 0: _path = "./resources/sprites/r-typesheet42.gif"; break;
        case 1: _path = "./resources/sprites/r-typesheet1.gif"; break;
        case 2: _path = "./resources/sprites/r-typesheet18.gif"; break;
        ...
        case 7: _path = "./resources/sprites/r-typesheet18.gif"; break;
        case 8: _path = "./resources/sprites/r-typesheet26.gif"; break;
        case 9: _path = "./resources/sprites/r-typesheet20.gif"; break;
    }
    _type = type;
